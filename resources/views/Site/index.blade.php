...
{{--                                <img src="{{asset('site/images/img-loading.png')}}" data-src="{{asset($servicelawyer->image)}}" alt="{{$servicelawyer->title}}" class="flip-img lazy" />--}}
{{--                                <a href="#" class="flip-content d-flex align-items-center justify-content-center">--}}
{{--                                    <div>--}}
{{--                                        <h3 class="flip-title mb-1">{{$servicelawyer->title}}</h3>--}}
{{--                                    </div>--}}
{{--                                </a>--}}
{{--                            </div>--}}
...
{{--    </section>--}}
            ...
            <div class="blog-post-carousel owl-action-styled half-shape">
                @foreach($servicelawyers as $servicelawyer)
                    <div class="col-lg-12 responsive-column-half text-center">
                        ...
                        <div class="category-item category-item-layout-2" style="min-height: 260px;position: initial;">
    ...
    <section class="blog-area bg-gray section--padding overflow-hidden">
        <div class="container">
            <div class="section-heading text-center">
...
{{--                            <img class="card-img-top" src="{{asset($akhbar->image)}}" alt="درپوش تصویر کارت">--}}
{{--                        </a>--}}
{{--                        <div class="course-badge-labels">--}}
{{--                            <div class="course-badge">{{jdate($akhbar->updated_at)->ago()}}</div>--}}
{{--                        </div>--}}
...
{{--                    <div class="card-body">--}}
{{--                        <h5 class="card-title"><a href="#">{{$akhbar->title}}</a></h5>--}}
{{--                        <p>{!! $akhbar->description !!}</p>--}}
{{--                        <ul class="generic-list-item generic-list-item-bullet generic-list-item--bullet d-flex align-items-center flex-wrap fs-14 pt-2">--}}
{{--                            <li class="d-flex align-items-center"> نویسنده :  {{$akhbar->username}} </li>--}}
{{--                        </ul>--}}
{{--                        <ul class="generic-list-item generic-list-item-bullet generic-list-item--bullet d-flex align-items-center flex-wrap fs-14 pt-2">--}}
{{--                        <li class="d-flex align-items-center">14 بازدید</li>--}}
{{--                        <li class="d-flex align-items-center">3 نظر</li>--}}
{{--                        </ul>--}}
{{--                        <div class="d-flex justify-content-between align-items-center float-left pt-3">--}}
{{--                            <a href="#" class="btn theme-btn theme-btn-sm theme-btn-white">ادامه مطلب </a>--}}
{{--                        </div>--}}
{{--                    </div>--}}
{{--                </div>--}}
                @endforeach
                ...
                @foreach($emploees as $emploee)
                        <div class="responsive-column-half">
                            <div class="card card-item member-card text-center">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title"><a href="#">{{$emploee->fullname}}</a></h5>
